...
public class SymbolUsedAsConstructorCheckTest {
  ...
  @Test
  public void test() {
    JavaScriptCheckVerifier.verify(check, new File(CHECK_DIR, "symbolUsedAsConstructor.js"));
    JavaScriptCheckVerifier.verify(check, new File(CHECK_DIR, "symbolUsedAsConstructor2.js"));
  }
